...
# ============================================================
# La paleta de marca (clara Y oscura) vive en .streamlit/config.toml
# ([theme.light] / [theme.dark]), no aquí. Eso es a propósito: así
# Streamlit la aplica de forma nativa y consistente según el modo del
# visor (claro/oscuro/"usar el del sistema"), incluyendo widgets,
# botones y el sidebar, sin que el CSS de esta app tenga que adivinar
# qué tema está activo.
#
# El CSS de abajo SOLO toca cosas que no dependen de claro/oscuro
# (tipografía y grosor de bordes), a propósito para no romper el
# contraste en modo oscuro. IMPORTANTE: nunca fijar aquí un color de
# texto/fondo en hexadecimal fijo (ej. "color: #0B1760") — eso es lo
# que causaba que los encabezados fueran ilegibles en modo oscuro
# corporativo, porque el color quedaba pintado sobre un fondo oscuro.
#
...
st.markdown(
    ...
    [data-testid="stSidebar"] h1 {
        ...
        /* Sin color fijo: hereda el textColor del tema activo (claro u oscuro). */
    }
